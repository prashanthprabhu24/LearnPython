...
* We use a language little bit similar to english called Assembly Level Language on Assembler and Assembler converts it to machine language and send it to computer(CPU perticularly).<br/>
